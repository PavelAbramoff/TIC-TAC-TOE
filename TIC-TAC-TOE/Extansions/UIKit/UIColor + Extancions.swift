...
extension UIColor {
    ...
    static let blue = #colorLiteral(red: 0.5176470588, green: 0.5019607843, blue: 0.831372549, alpha: 1)
    static let black = #colorLiteral(red: 0.137254902, green: 0.1607843137, blue: 0.2745098039, alpha: 1)
    static let grey = #colorLiteral(red: 0.8039215686, green: 0.8117647059, blue: 0.8509803922, alpha: 1)
}
